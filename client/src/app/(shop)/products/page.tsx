...
const products: ProductCardProps[] = [
  ...
  {
    title: ".xyz Indian Scripted WebSites",
    price: 4999.00,
    category: "AdSense",
    followers: "14k",
    sku: "1-1-1",
  ...
  {
    title: "1 Payment Received | 2 Site in Hindi",
    price: 29999.00,
    category: "AdSense",
    followers: "14k",
    sku: "1000-2-1-1-1-3",
  ...
  {
    title: "1 Payment Received | 2 Site in English",
    price: 34999.00,
    category: "AdSense",
    followers: "14k",
    sku: "1000-2-1-1-1-3-2",
    status: "out-of-stock",
    imageUrl: "/api/placeholder/300/300"
  }
];
      ...
      <div className="flex flex-col md:flex-row gap-4 sm:gap-8">
        ...
        <div className="flex-1">
          ...
          <div className={`grid grid-cols-1 ${
            activeView === 'list' ? 'sm:grid-cols-1' : 
            activeView === 'large-grid' ? 'grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-4' : 
            'sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3'
          } gap-4 sm:gap-6`}>
            {products.map((product, index) => (
              <div key={index} className={activeView === 'list' ? 'col-span-1' : ''}>
                <ProductCard {...product} />
              </div>
            ))}
          </div>
